...
<template>
    <div class="relative flex flex-col flex-1">
        <div class="mb-4 flex items-center justify-between">
            <NuxtLink to="/dashboard/orders" :class="cn(buttonVariants({ variant: 'link' }))">
                <IconArrowLeft />
                Назад до замовлень
            </NuxtLink>
            ...
            <Card>
                <div class="flex flex-col space-y-1.5 p-6">
                    <h3 class="tracking-tight text-2xl font-bold">
                        Замовлення ORD-12345
                    </h3>
                    <p class="text-sm text-muted-foreground">
                        Розміщено 2023-04-15
                    </p>
                </div>
                <CardContent>
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            </h3><p>Alice Johnson</p><p>alice@example.com</p><p class="text-sm text-muted-foreground">
                            ...
                            <div class="flex items-center gap-2">
                                <IconCreditCard :size="16" :stroke-width="1.5" class="font-normal" />
                                Visa ending in **** 1234
                            </div>
                        </div>
                    </div>
            ...
            <Card>
                ...
                <div class="p-6 pt-0 space-y-4">
                    <div class="flex justify-between">
                        <span>Підсумок</span><span>$101.97</span>
                    </div><div class="flex justify-between">
                        <span>Доставка</span><span>$10.00</span>
                    </div><div data-orientation="horizontal" role="none" class="shrink-0 bg-border h-[1px] w-full" /><div class="flex justify-between font-semibold">
                        <span>Всього</span><span>$111.97</span>
                    </div>
                </div>
            </Card>
                ...
                <CardContent>
                    ...
                    <div class="space-y-6">
                        <Stepper>
                            ...
                            >
                                <StepperTrigger>
                                    <StepperIndicator class="w-[45px] h-[45px]">
                                        <component :is="item.icon" class="w-[18px] h-[18px]" />
                                    </StepperIndicator>
                                    <div class="flex flex-col">
                                        <StepperTitle class="sr-only">
                                            stepper title
                                        </StepperTitle>
                                        <StepperDescription>
                                            {{ item.title }}
                        ...
                        <Progress class="h-3" :model-value="2" />
